...
import org.thoughtcrime.securesms.StarredMessageActivity;
                                                                      ...
                                                                      MegaphoneActionController
{
  ...
  private PulsingFloatingActionButton       listStarMsg;
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    listStarMsg        = view.findViewById(R.id.starred_msg);
    ...
    listStarMsg.setOnClickListener(v -> startActivity(new Intent(getActivity(), StarredMessageActivity.class)));
